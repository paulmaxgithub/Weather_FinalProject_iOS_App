//
//  HeaderAndFooterUIView.swift
//  WeatherAppTestProject
//
//  Created by Paul Max on 9/2/20.
...
extension WeatherVC {
    ...
    func createTableHeader() -> UIView {
        ...
        temperatureLabel.font = UIFont(name: "HelveticaNeue-Thin", size: 90)
        ...
        currentDayLabel.font = UIFont(name: "HelveticaNeue", size: 15)
        ...
        todayLabel.font = UIFont(name: "HelveticaNeue-Bold", size: 15)
        ...
        currentHighTempLabel.font = UIFont(name: "HelveticaNeue", size: 15)
        ...
        currentLowTempLabel.font = UIFont(name: "HelveticaNeue", size: 15)
    ...
    func createTableFooter() -> UIView {
        ...
        summaryLabel.font = UIFont(name: "HelveticaNeue-Light", size: 15)
        ...
        sunriseTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        sunriseTime.font = UIFont(name: "HelveticaNeue", size: 27)
        ...
        sunsetTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        sunsetTime.font = UIFont(name: "HelveticaNeue", size: 27)
        ...
        chanceOfRainTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        chanceOfRainNumber.font = UIFont(name: "HelveticaNeue", size: 27)
        ...
        humidityTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        windTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        windTitle.alpha = 0.5
        ...
        feelsLikeTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        feelsLikeNumber.font = UIFont(name: "HelveticaNeue", size: 27)
        ...
        precipitationTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        pressureTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        pressureNumber.font = UIFont(name: "HelveticaNeue", size: 27)
        ...
        visibilityTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        uvIndexTitle.font = UIFont(name: "HelveticaNeue", size: 10)
        ...
        uvIndexNumber.font = UIFont(name: "HelveticaNeue", size: 27)
